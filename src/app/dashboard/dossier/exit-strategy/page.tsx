...
const FALLBACK_BLOCKS: BlockData[] = [
  {
    ...
    type: "TextBlock",
    props: {
      text: "<span class='badge badge-gold'>Investment Dossier</span><span class='badge badge-success ml-2'>Exit Strategy</span><h1 class='text-gold font-display font-black mb-3 text-4xl mt-4'>Exit Strategy</h1>"
    }
  },
  {
    id: "div-1",
  ...
  },
  {
    id: "text-1",
    type: "TextBlock",
    props: { text: "<p class='text-text-secondary'>Liquidity events, dividend models, and targeted capital return timelines.</p>" }
  }
]
