...
const FALLBACK_BLOCKS: BlockData[] = [
  {
    ...
    type: "TextBlock",
    props: {
      text: "<span class='badge badge-gold'>Investment Dossier</span><span class='badge badge-info ml-2'>Financial Model</span><h1 class='text-gold font-display font-black mb-3 text-4xl mt-4'>Financial Model</h1>"
    }
  },
  {
    id: "div-1",
  ...
  },
  {
    id: "text-1",
    type: "TextBlock",
    props: { text: "<p class='text-text-secondary'>Financial projections and working capital modelling for the Chikonga Mine transformation.</p>" }
  }
]
